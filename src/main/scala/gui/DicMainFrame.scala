...
//
//import control.{QueryContentFactory, Translator}
//import entity.{Sentence, dao.Word}
//
...
//        if(text!="")
//        {
//          val queryContent = QueryContentFactory.create(text)
//          val result = Translator.translate(queryContent)
//          result match {
//            case word:dao.Word =>
//              if(word.type_mean.nonEmpty){
//                resultArea.text += word.query+"\n"
...
//              resultArea.text += sentence.query + "\n"
//              resultArea.text += sentence.meaning+"\n"
//            case _ => resultArea.text += s"${result.query} \n unknown meaning \n"
//          }
//          resultArea.text += "---------------------------\n"
//        }
//    }
